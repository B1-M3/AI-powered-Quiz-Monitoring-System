...
use App\Http\Controllers\Api\ApexiaQuizApiController;
...
// ---------------------------------------------------------------------------
// STEP 25: Apexia AI Quiz Monitoring API (quiz start, submit, AI, risk, video, notifications, warnings)
// ---------------------------------------------------------------------------
Route::middleware(['auth:sanctum'])->group(function () {
    Route::post('/quiz/start', [ApexiaQuizApiController::class, 'start']);
    Route::post('/quiz/submit-answer', [ApexiaQuizApiController::class, 'submitAnswer']);
    Route::post('/ai/detection', [ApexiaQuizApiController::class, 'detection']);
    Route::get('/risk-scores/{quizId}', [ApexiaQuizApiController::class, 'riskScores']);
    Route::post('/video/upload-segment', [ApexiaQuizApiController::class, 'uploadSegment']);
    Route::get('/notifications', [ApexiaQuizApiController::class, 'notifications']);
    Route::post('/warning/acknowledge', [ApexiaQuizApiController::class, 'acknowledgeWarning']);
});
